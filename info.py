...
BOT_TOKEN = "6865138281:AAEnqGd14gtLIxkD9INxhbQYLo2Ds1bXHz4"
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1006159057 849970787').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002069589631')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rangoli:AMRKS@cluster0.f4c8vsd.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Telegram")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
IS_VERIFY = is_enabled((environ.get('IS_VERIFY', 'False')), False)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/PdiskTricks")
VERIFY2_URL = environ.get('VERIFY2_URL', "tnshort.net")
VERIFY2_API = environ.get('VERIFY2_API', "d70d2f40cefc0a39d81e1b2be77d409da78f8aed")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+9pkxMp-GANk1ZGEx')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/SUPERPOWER_BOT_SUPPORT')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002032811900 -1001198173566'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ROSE_MOVIE')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002134291959')).split()]
